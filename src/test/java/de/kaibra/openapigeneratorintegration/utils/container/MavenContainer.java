package de.kaibra.openapigeneratorintegration.utils.container;
    ...
    public void assertMvnCommandIsSuccessWithoutErrors() throws Throwable {
        try {
            ...
            Assert.assertThat(this.getLogs(),
                    StringContains.containsString("[INFO] BUILD SUCCESS"));

            Assert.assertThat(this.getLogs(),
                    CoreMatchers.not(StringContains.containsString("[ERROR]")));
        } finally {
            this.stop();
        }
    }
